...
var studentPaymentService = /** @class */ (function () {
    function studentPaymentService(_http) {
        this._http = _http;
    }
    studentPaymentService.prototype.getAllStudentPayments = function () {
        return this._http.get('http://localhost:5570/api/StudentPayment/GetAllStudentPayments')
            .map(function (response) { return response.json(); });
    };
    ;
    studentPaymentService.prototype.saveStudentPayment = function (StudentPayment) {
        var bodyString = JSON.stringify(StudentPayment); // Stringify payload
    ...
    ;
    studentPaymentService.prototype.updateStudentPayment = function (StudentPayment) {
        var bodyString = JSON.stringify(StudentPayment); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    studentPaymentService.prototype.deleteStudentPayment = function (StudentPayment) {
        var bodyString = JSON.stringify(StudentPayment); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    studentPaymentService = __decorate([
        core_1.Injectable(),
...
//# sourceMappingURL=studentPayment.service.js.map
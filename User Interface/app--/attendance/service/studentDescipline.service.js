...
var studentDesciplineService = /** @class */ (function () {
    function studentDesciplineService(_http) {
        this._http = _http;
    }
    studentDesciplineService.prototype.getStudentDesciplines = function () {
        return this._http.get("http://localhost:5570/api/StudentDiscipline/GetAllDisciplines")
            .map(function (response) { return response.json(); });
    };
    ;
    studentDesciplineService.prototype.saveStudentDescipline = function (StudentDescipline) {
        var bodyString = JSON.stringify(StudentDescipline); // Stringify payload
    ...
    ;
    studentDesciplineService.prototype.updateStudentDescipline = function (StudentDescipline) {
        var bodyString = JSON.stringify(StudentDescipline); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    studentDesciplineService.prototype.deleteStudentDescipline = function (StudentDescipline) {
        var bodyString = JSON.stringify(StudentDescipline); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    studentDesciplineService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http])
    ], studentDesciplineService);
    return studentDesciplineService;
}());
exports.studentDesciplineService = studentDesciplineService;
//# sourceMappingURL=studentDescipline.service.js.map
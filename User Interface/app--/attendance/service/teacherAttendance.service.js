...
var teacherAttendanceService = /** @class */ (function () {
    function teacherAttendanceService(_http) {
        this._http = _http;
    }
    teacherAttendanceService.prototype.getTeacherAttendances = function () {
        return this._http.get("http://localhost:5570/api/TeachersAttendance/GetTeachersAttendances")
            .map(function (response) { return response.json(); });
    };
    ;
    teacherAttendanceService.prototype.saveTeacherAttendance = function (TeacherAttendance) {
        var bodyString = JSON.stringify(TeacherAttendance); // Stringify payload
    ...
    ;
    teacherAttendanceService.prototype.updateTeacherAttendance = function (TeacherAttendance) {
        var bodyString = JSON.stringify(TeacherAttendance); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    teacherAttendanceService.prototype.deleteTeacherAttendance = function (TeacherAttendance) {
        var bodyString = JSON.stringify(TeacherAttendance); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    teacherAttendanceService = __decorate([
        core_1.Injectable(),
...
//# sourceMappingURL=teacherAttendance.service.js.map
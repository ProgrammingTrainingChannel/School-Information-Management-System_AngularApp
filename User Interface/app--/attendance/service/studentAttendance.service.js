...
var studentAttendanceService = /** @class */ (function () {
    ...
    studentAttendanceService.prototype.getStudentAttendances = function () {
    ...
    studentAttendanceService.prototype.saveStudentAttendance = function (StudentAttendance) {
        var bodyString = JSON.stringify(StudentAttendance); // Stringify payload
    ...
    ;
    studentAttendanceService.prototype.deleteStudentAttendance = function (StudentAttendance) {
        var bodyString = JSON.stringify(StudentAttendance); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option

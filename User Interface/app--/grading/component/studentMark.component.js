...
var studentMarkComponent = /** @class */ (function () {
    ...
    studentMarkComponent.prototype.LoadSingleStudentMark = function (SelectedStudentMark) {
        ...
        this._studentService.getStudents()
            .subscribe(function (resultData) {
            _this.ListOfStudents = resultData;
            _this.SelectedGradeID = _this.studentMark.GradeID;
            _this.SelectedGradeSectionID = _this.studentMark.GradeSectionID;
            _this.SelectedExamTypeID = _this.studentMark.ExamTypeID;
            _this.SelectedCourseID = _this.studentMark.CourseID;
            _this.SelectedAcademicQuarterID = _this.studentMark.AcademicQuarterID;
            _this.SelectedStudentID = _this.studentMark.StudentID;
        }, function (error) {
            alert('getStudents failed!');
        });
    };

...
var paymentReasonService = /** @class */ (function () {
    function paymentReasonService(_http) {
        this._http = _http;
    }
    paymentReasonService.prototype.getPaymentReasons = function () {
        return this._http.get('http://localhost:5570/api/PaymentReason/GetPaymentReasons')
            .map(function (response) { return response.json(); });
    };
    ;
    paymentReasonService.prototype.savePaymentReason = function (paymentReason) {
        var bodyString = JSON.stringify(paymentReason); // Stringify payload
    ...
    ;
    paymentReasonService.prototype.updatePaymentReason = function (paymentReason) {
        var bodyString = JSON.stringify(paymentReason); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    paymentReasonService.prototype.deletePaymentReason = function (paymentReason) {
        var bodyString = JSON.stringify(paymentReason); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    paymentReasonService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http])
    ], paymentReasonService);
    return paymentReasonService;
}());
exports.paymentReasonService = paymentReasonService;
//# sourceMappingURL=paymentReason.service.js.map
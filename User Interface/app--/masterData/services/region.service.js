...
var regionService = /** @class */ (function () {
    ...
    ;
    regionService.prototype.saveRegion = function (region) {
        var bodyString = JSON.stringify(region); // Stringify payload
    ...
    ;
    regionService.prototype.deleteRegion = function (region) {
        var bodyString = JSON.stringify(region); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
